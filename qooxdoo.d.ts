...
declare module qx.bom {
class Selection {
 static get(node:any):string;
 static getEnd(node:any):number;
 static getLength(node:any):number;
...
declare module qx.dom {
class Node {
 static getBodyElement(node:any):HTMLElement;
 static getDocument(node:any):Document;
 static getDocumentElement(node:any):HTMLElement;
 static getName(node:any):string;
 static getText(node:any):string;
 static getWindow(node:any):Window;
...
constructor (url?:string);
 _createTransport():qx.bom.request;
...
constructor (stateName:string,stateInfo:IMap);
 ...
 autoActionsAfterOnentry:any;
 autoActionsAfterOnexit:any;
 autoActionsBeforeOnentry:any;
 autoActionsBeforeOnexit:any;
 events:any;
 name:any;
 onentry:any;
 onexit:any;
...
constructor (transitionName:string,transitionInfo:any);
 ...
 autoActionsAfterOntransition:any;
 autoActionsBeforeOntransition:any;
 name:string;
 nextState:any;
 ontransition:any;
 predicate:any;
